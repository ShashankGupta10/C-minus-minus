<h2><a href="https://leetcode.com/problems/determine-color-of-a-chessboard-square">Determine Color of a Chessboard Square</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>You are given <code>coordinates</code>, a string that represents the coordinates of a square of the chessboard. Below is a chessboard for your reference.</p>
